  ...
  <div id="frame">
    ...
    <div class="content">
      <div class="contact-profile">
        ...
        <p>
          <span v-for="part in getParticipants()" :key="part.id">
      ...
      <div class="messages">
        <ul>
          <li
            :class="
              parseInt(message.node.sender.id) === user.pk ? 'sent' : 'replies'
            "
            v-for="message in messages(current_chat.id)"
            :key="message.node.id"
          >
            ...
            <p>
              ...
              <small style="font-size: 10px">{{
                new Date(message.node.created).toLocaleString()
              }}</small>
            </p>
          </li>
        </ul>
